...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            return albumMsg;
            ...
            else if (typeof content === 'object' && 'interactiveMessage' in content && content.interactiveMessage) {
                const interactiveMsg = await Utils_1.prepareInteractiveMessageContent(jid, content.interactiveMessage, {
                    sock: { relayMessage, waUploadToServer },
                    userJid,
                    quoted: options.quoted,
                    ephemeralExpiration: options.ephemeralExpiration,
                    ...options
                ...
                await relayMessage(jid, interactiveMsg.message, relayOption);
