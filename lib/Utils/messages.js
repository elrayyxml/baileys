...
const prepareInteractiveMessageContent = async (jid, content, options) => {
    ...
    if (mediaToUpload) {
        media = await (0, exports.prepareWAMessageMedia)(mediaToUpload, {
    ...
    const interactiveMessage = {
        body: { text: raw.text || raw.caption || raw.title || '' },
        footer: { text: raw.footer || '' },
        header: {
            title: raw.header || raw.title || '',
            subtitle: raw.subtitle || '',
            hasMediaAttachment: !!media,
            ...(media ? media[Object.keys(media)[0]] : {})
        },
        nativeFlowMessage: raw.nativeFlowMessage ? {
            buttons: raw.nativeFlowMessage.buttons || [],
            messageParamsJson: raw.nativeFlowMessage.messageParamsJson || ''
        } : {
            buttons: raw.buttons || [],
