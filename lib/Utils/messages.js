...
exports.prepareInteractiveMessageContent = exports.prepareAlbumMessageContent = exports.assertMediaContent = exports.downloadMediaMessage = exports.aggregateMessageKeysNotFromMe = exports.updateMessageWithPollUpdate = exports.updateMessageWithReaction = exports.updateMessageWithReceipt = exports.getDevice = exports.extractMessageContent = exports.normalizeMessageContent = exports.getContentType = exports.generateWAMessage = exports.generateWAMessageFromContent = exports.generateWAMessageContent = exports.generateForwardMessageContent = exports.prepareDisappearingMessageSettingContent = exports.prepareWAMessageMedia = exports.generateLinkPreviewIfRequired = exports.extractUrlFromText = void 0;
...
const prepareInteractiveMessageContent = async (jid, content, options) => {
    const raw = content;
    let media = null;
    let mediaToUpload = raw.image ? { image: raw.image } : 
                        raw.video ? { video: raw.video } : 
                        raw.document ? { document: raw.document, fileName: raw.fileName, mimetype: raw.mimetype } : null;

    if (mediaToUpload) {
        media = await (0, exports.prepareWAMessageMedia)(mediaToUpload, options);
    }

    const interactiveMessage = {
        body: typeof raw.body === 'object' ? raw.body : { text: raw.text || raw.caption || raw.body || '' },
        footer: typeof raw.footer === 'object' ? raw.footer : { text: raw.footer || '' },
        header: typeof raw.header === 'object' ? { ...raw.header, ...media } : {
            title: raw.title || raw.header || '',
            subtitle: raw.subtitle || '',
            hasMediaAttachment: !!media,
            ...media
        },
        nativeFlowMessage: raw.nativeFlowMessage ? raw.nativeFlowMessage : {
            buttons: raw.buttons || [],
            messageParamsJson: raw.messageParamsJson || ''
        },
        contextInfo: {
            mentionedJid: raw.mentions || (raw.contextInfo ? raw.contextInfo.mentionedJid : []),
            ...raw.contextInfo
        }
    };
    ...
    if (raw.viewOnce !== false) {
        ...
        return (0, exports.generateWAMessageFromContent)(jid, { viewOnceMessage }, options);
    }

    return (0, exports.generateWAMessageFromContent)(jid, msg, options);
};
exports.prepareInteractiveMessageContent = prepareInteractiveMessageContent;
