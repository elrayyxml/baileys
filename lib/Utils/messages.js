...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
       ...
       pollResultSnapshotMessage.contextInfo = {
        ...
        const stickerData = {}
        const stickerPackId = (0, crypto_1.randomBytes)(16).toString('hex').replace(/(.{8})(.{4})(.{4})(.{4})(.{12})/, '$1-$2-$3-$4-$5');
        ...
        const rawSha256Hex = crypto_2.sha256(coverBuffer).toString('hex');
        const imageDataHash = Buffer.from(rawSha256Hex).toString('base64');
