...
const generateWAMessageContent = async (message, options) => {
    ...
    const stickerPackUpload = await (0, messages_media_1.encryptedStream)(zipBuffer, 'sticker', {
        logger: options.logger,
        opts: options.options
    });
        console.log('encryptedStream result keys:', Object.keys(stickerPackUpload));
    ...
    try {
        const thumbUpload = await (0, messages_media_1.encryptedStream)(thumbnailBuffer, 'sticker', {
            logger: options.logger,
            opts: options.options,
